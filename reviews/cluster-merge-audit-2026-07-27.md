# Cross-day cluster merge audit — 2026-07-27
...
- `data/cluster_continuity.json` 엔트리: **2,940개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **2,041개**
...
- 총 병합 이벤트: **4,495건**
- 종류별: same_day 504 · cross_near 3991 · cross_far 0
