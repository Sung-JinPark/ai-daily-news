# Cross-day cluster merge audit — 2026-08-24
...
- `data/cluster_continuity.json` 엔트리: **5,053개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **4,154개**
...
- 총 병합 이벤트: **9,679건**
- 종류별: same_day 1035 · cross_near 8644 · cross_far 0
