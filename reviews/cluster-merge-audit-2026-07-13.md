# Cross-day cluster merge audit — 2026-07-13
...
- `data/cluster_continuity.json` 엔트리: **1,870개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **971개**
...
- 총 병합 이벤트: **2,218건**
- 종류별: same_day 251 · cross_near 1967 · cross_far 0
