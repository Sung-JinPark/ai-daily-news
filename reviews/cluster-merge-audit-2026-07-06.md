# Cross-day cluster merge audit — 2026-07-06
...
- `data/cluster_continuity.json` 엔트리: **1,371개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **471개**
...
- 총 병합 이벤트: **873건**
- 종류별: same_day 119 · cross_near 754 · cross_far 0
