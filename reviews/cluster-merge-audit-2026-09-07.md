# Cross-day cluster merge audit — 2026-09-07
...
- `data/cluster_continuity.json` 엔트리: **6,127개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **5,228개**
...
- 총 병합 이벤트: **12,055건**
- 종류별: same_day 1275 · cross_near 10780 · cross_far 0
