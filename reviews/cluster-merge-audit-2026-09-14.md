# Cross-day cluster merge audit — 2026-09-14
...
- `data/cluster_continuity.json` 엔트리: **6,589개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **5,690개**
...
- 총 병합 이벤트: **12,971건**
- 종류별: same_day 1346 · cross_near 11625 · cross_far 0
