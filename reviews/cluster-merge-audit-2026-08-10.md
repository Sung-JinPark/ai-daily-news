# Cross-day cluster merge audit — 2026-08-10
...
- `data/cluster_continuity.json` 엔트리: **4,025개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **3,126개**
...
- 총 병합 이벤트: **7,069건**
- 종류별: same_day 759 · cross_near 6310 · cross_far 0
