# Cross-day cluster merge audit — 2026-07-20
...
- `data/cluster_continuity.json` 엔트리: **2,406개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **1,507개**
...
- 총 병합 이벤트: **3,376건**
- 종류별: same_day 365 · cross_near 3011 · cross_far 0
