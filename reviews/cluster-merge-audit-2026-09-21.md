# Cross-day cluster merge audit — 2026-09-21
...
- 대상 일수: **106일**
- 기사 총계: **7,765건**
- 관측된 cluster_id 수: **7,612개**
- day_span >= 30일 클러스터: **2개**
...
- `data/cluster_continuity.json` 엔트리: **6,626개**
- `last_titles` 필드 있는 엔트리 (R1 이후 갱신됨): **6,029개**
...
### `k003631` — span 30일 · 멤버 2 · 매체 1 · 카테고리 {'community': 2}
- 기간: 2026-08-04 → 2026-09-02
- 소스별 카운트: arstechnica×2
- 대표 제목 샘플:
...
- 총 병합 이벤트: **13,858건**
- 종류별: same_day 1455 · cross_near 12403 · cross_far 0
